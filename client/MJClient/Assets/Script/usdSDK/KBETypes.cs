...
namespace KBEngine
{
	...
	public struct ENTITY_ID
	{
		...
		public static implicit operator ENTITY_ID(UInt32 value)
		{
			UInt32 tvalue = (UInt32)value;
	...
	public struct MJPAI
	{
		...
		public static implicit operator MJPAI(SByte value)
		{
			SByte tvalue = (SByte)value;
	...
	public class PLAYRE_DATA_LIST : List<PLAYRE_DATA>
	{
